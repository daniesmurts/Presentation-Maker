...
//
// The failure this exists for, from production 2026-09-09: a user of the parent product pressed
 ...
 * a list of independent items, the user is looking at an editor for it,
