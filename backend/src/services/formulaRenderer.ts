...
// Renders LaTeX formulas to PNG for the PPTX export (talkExport.ts).
...
// (frontend/src/components/talks/Math.tsx) instead of the Unicode
// flattening in latexText.ts, which stays as the fallback below.
//
