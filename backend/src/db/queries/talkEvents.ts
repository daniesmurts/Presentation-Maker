...
export interface TalkEvent {
  ...
  event:       'exported' | 'subscribed' | 'renewed' | 'payment_failed' | 'renewal_failed' | 'refunded' | 'auto_renew_off' | 'auto_renew_on' | 'image_generated' | 'pro_granted' | 'pro_grant_revoked' | 'promo_redeemed'
  format?:     'pptx' | 'pdf'
